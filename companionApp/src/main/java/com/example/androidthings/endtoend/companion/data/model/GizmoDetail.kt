 ...
 */
data class GizmoDetail(
    val gizmo: Gizmo,
    val toggleDetails: List<ToggleDetail> = emptyList()
) {
    override fun equals(other: Any?): Boolean {
        return other == this || (other is GizmoDetail && other.gizmo == this.gizmo)
    }

    override fun hashCode() = gizmo.hashCode()
}
